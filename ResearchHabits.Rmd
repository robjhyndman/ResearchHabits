...
\only<3>{\placefig{10}{2.2}{width=6cm}{yoda}}
...
\begin{textblock}{7.7}(7.9,6.64)\fontsize{12}{13}\sf
...
\placefig{9.2}{1.6}{width=5.3cm}{Mendeley}
...
\placefig{8.7}{2.6}{width=6.1cm}{Paperpile}
...
\full{semantic-scholar.png}

# Scripting

## Reproducibility

\begin{textblock}{9.5}(0.5,1.3)\fontsize{14}{15}\sf
...
\placefig{10.65}{0}{width=5.35cm}{2g9914}
...
\placefig{11.5}{5.9}{width=3.2cm}{github}
...
\placefig{4.1}{1.35}{width=11.9cm}{problems}
...
{\fontsize{14}{14}\tt{github.com/numbats/\rlap{monash}}}
\item[\textcolor{white}{\ding{229}}] Useful for assignments too
\item[\textcolor{white}{\ding{229}}] See \url{rmarkdown.rstudio.com} for help
\end{itemize}
\end{alertblock}
\end{textblock}
...
\url{github.com/numbats/monash-quarto-thesis}
\item[\textcolor{white}{\ding{229}}] Useful for assignments too
